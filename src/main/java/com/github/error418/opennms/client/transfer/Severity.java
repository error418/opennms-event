...
/**
 * Represents OpenNMS Severity Levels.
 * The severity level Enum JavaDocs are taken from the OpenNMS documentation.
 */
...
public enum Severity {
	...
	/**
	 * A part of a device (a service, and interface, a power supply, etc.) has stopped functioning.
	 ...
	 * This severity can also be used to indicate a condition that should be noted (logged) but does not require direct action.
	 */
	@XmlEnumValue("4")
	WARNING(4),
	...
	/**
	 * This severity is reserved for use in Alarms to indicate that an alarm describes a self-clearing error condition has
	 * been corrected and service is restored.
